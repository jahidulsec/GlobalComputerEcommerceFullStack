...
const PCBuildCatPage = ({children, params}) => {
    ...
    useEffect(() => {
        router.push(pathname + '?' + createQueryString('sorting', order, 'price')) 
    }, [order])
  ...
  return (
    <section className='pc-build-cat-page'>
                                    ...
                                    <div className="cat-head">
                                        <div className="breadcrump">
                                            <ul className="flexitem">
                                                ...
                                                <li><Link href="/tool/pc-build">PC Build</Link></li>
