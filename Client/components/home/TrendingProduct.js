...
const TrendingProduct = async () => {
  const productBig = await getGeneralGET({
    name: `display-product`,
    display_big: `true`,
  });
  const offeredProduct = await getGeneralGET({
    name: `display-product`,
    page: 1,
    size: 6,
    offered: 1,
