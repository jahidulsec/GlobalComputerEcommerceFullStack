...
export const generateMetadata = async() => {
  ...
  return {
    title: `Policies| Global Computer (BD)` || `Global Computer (BD)`,
    robots: {
      index: true,
      follow: true,
      googleBot: {
    ...
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_APP_URL}/policies`,
    }
  }
} 
                ...
                <section className='policies__content'>
                      ...
                      <ul>
                        ...
                        <li>
                          <p>
                            ...
                            with a party, where <b>control</b> means ownership of 50% or more of the shares, equity interest or other securities 
                            entitled to vote for election of directors or other managing authority.
                          </p>
                        </li>
                        <li>
                          <p>
                            <strong>Company</strong> (referred to as either <b>the Company</b>, <b>We</b>, <b>Us</b> or <b>Our</b> in this Agreement) 
                        ...
                        <li>
                          <p>
                            <strong>Website</strong> refers to Global Computer (BD), accessible from <Link href={`/`}>globalcomputer.com.bd</Link>
                          </p>
                        </li>
                        <li>
                          <p>
                  ...
                  <article>
                    ...
                    <section>
                      ...
                      <p>
                        Cookies can be <b>Persistent</b> or <b>Session</b> Cookies. Persistent Cookies remain on Your personal computer or mobile device 
                  ...
                  <article>
                    ...
                    <p>
                      ...
                      update the <b>Last updated</b> date at the top of this Privacy Policy. <br />
                  ...
                  <article>
                    ...
                    <p>
                      If you have any questions about this Privacy Policy, You can contact us: <br />
                        By visiting this page on our website: <Link href={`${process.env.NEXT_PUBLIC_API_URL}/contact`}>Contact us</Link>
                    </p>
                  </article>
                </section>
            </div>
