...
from .serializers import DisplayProductBrandSerializer, DisplayProductSerializer, SubSideMenuSerializer, UserProfileSerializer, SingleOrderSerializer, NewstellerSerializer, ReviewSerializer, CategorySerializer, BrandSerializer, BannerSerializer, ProductSerializer, KeyFeatureSerializer, SliderSerializer, OrderItemSerializer, OrderSerializer, SpecificationSerializer, SpecTableSerializer, SingleProductSerializer, ReviewSerializer, SideMenuSerializer, SingleProductImageSerializer
...
#     return Response(brand.split(','), 200)
    
# class TestView(generics.ListAPIView):
#     queryset = Product.objects.all()
#     serializer_class = DisplayProductBrandSerializer
#     pagination_class = SetPagination
#     filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
#     filterset_class = ProductFilter  # model__field
#     search_fields = ['title']
...
#         # serializer = DisplayProductBrandSerializer(queryset, many=True)
#         # for brand in serializer.data:
...
class SingleSpecTableView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Specification.objects.all()
    serializer_class = SpecificationSerializer
...
# start from here
class SingleSpecAddInTable(generics.CreateAPIView):
